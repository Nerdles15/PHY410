...
if plotfirst == True : 
    ...
    # data downloaded from https://data.giss.nasa.gov/gistemp/
    print ' Global Temp data from NASA GISS '
    data_file_name = 'GLB.Ts.csv'
    ...
    #plt.subplot(2, 1, 1)
    plt.plot( x, y )
    plt.xlabel('Year, starting with 1880')
    plt.ylabel('Avg temp deviation (C)')
